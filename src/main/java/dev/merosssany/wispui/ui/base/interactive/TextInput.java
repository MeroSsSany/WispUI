...
import dev.merosssany.wispui.event.input.keyboard.CharacterInputEvent;
...
/**
 * A versatile single-line text input field.
 * <p>
 * This component handles focus-based input, character insertion, backspacing,
 * and caret (cursor) rendering. It supports "Natural Clipping," where long text
 * is truncated with an ellipsis, and the view follows the caret position.
 * </p>
 *
 *
 *
 * <h2>Key Features</h2>
 * <ul>
 * <li><b>Caret Management:</b> A blinking cursor that tracks the insertion index
 * and maps mouse clicks to character positions.</li>
 * <li><b>Hint Text:</b> Displays a placeholder string when the input is empty.</li>
 * <li><b>Keyboard Shortcuts:</b> Supports Ctrl+Backspace for word deletion,
 * Ctrl+V for clipboard pasting, and Enter for submission.</li>
 * <li><b>Focus Logic:</b> Captures global mouse events to unfocus when clicking
 * outside the input bounds.</li>
 * </ul>
 */
