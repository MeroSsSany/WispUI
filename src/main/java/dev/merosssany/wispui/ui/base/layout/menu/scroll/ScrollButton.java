package dev.merosssany.wispui.ui.base.layout.menu.scroll;
...
/**
 * Represents the interactive scrollbar handle (Thumb) and its background (Track).
 * <p>
 * This component acts as a bridge between user input and the {@link ScrollableMenu}.
 * It maps the local Y-offset of the handle on the track to the global scroll
 * percentage of the menu's content.
 * </p>
 *
 *
 *
 ...
 * <p>
 * The scroll ratio is calculated as:
 * <code>scrollPercent = currentHandleY / (trackHeight - handleHeight)</code>
 * <p>
...
public class ScrollButton extends UI { // The Scroll Handle/Thumb
    ...
    /**
     * Handles the movement of the scroll thumb during a drag operation.
     * <p>
     * Translates window coordinates to virtual space, calculates the
     * handle's clamped position on the track, and updates the parent
     * menu's scroll target.
     * </p>
     */
    @SubscribeEvent
    ...
    /**
     * Updates the handle's position based on external scroll changes (e.g., Mouse Wheel).
     * <p>
     * This is called by the {@link ScrollableMenu} to ensure the visual scrollbar
     * matches the current content position.
     * </p>
     *
     * @param menuScrollY
     *         The current absolute scroll distance of the menu.
     */
